  ...
  const emailSendHandeler = async (event) => {
    ...
    try {
      ...
      const response = await fetch(
        `https://mail-boxclient-eb982-default-rtdb.firebaseio.com/${sEmail}/sentMailbox.json`,
        {
          method: "POST",
    ...
    try {
      ...
      const response = await fetch(
        `https://mail-boxclient-eb982-default-rtdb.firebaseio.com/${rEmail}/inbox.json`,
        {
          method: "POST",
          body: JSON.stringify({
            from: email,
